...
const MethodChannel _channel = MethodChannel('plugins.flutter.io/local_auth_android');
...
class LocalAuthAndroid extends LocalAuthPlatform {
  ...
  @override
  Future<List<BiometricType>> getEnrolledBiometrics({bool strongBiometricsOnly = false}) async {
    final List<String> result = (await _channel.invokeListMethod<String>('getEnrolledBiometrics', {
