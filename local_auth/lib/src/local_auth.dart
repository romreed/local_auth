...
class LocalAuthentication {
  ...
  Future<bool> authenticate(
    ...
    print("options ${options.strongBiometricsOnly}");
  ...
  Future<List<BiometricType>> getAvailableBiometrics({bool strongBiometricsOnly = false}) =>
      LocalAuthPlatform.instance.getEnrolledBiometrics(strongBiometricsOnly: strongBiometricsOnly);
}
